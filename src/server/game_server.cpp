              ...
              RoomActorBindingConfig{
                  .actor =
                      RoomConfig{
                          ...
                          .arena_width = config.room_arena_width,
                          .arena_height = config.room_arena_height,
                          .player_move_speed = config.room_player_move_speed,
                          .participant_spawn_spacing = config.room_participant_spawn_spacing,
                          .minion_spawn_radius = config.room_minion_spawn_radius,
                          .minion_move_speed = config.room_minion_move_speed,
                          .boss_move_speed = config.room_boss_move_speed,
                          .minion_attack_damage = config.room_minion_attack_damage,
                          .boss_attack_damage = config.room_boss_attack_damage,
                          .minion_attack_range = config.room_minion_attack_range,
                          .boss_attack_range = config.room_boss_attack_range,
                          .minion_attack_cooldown = config.room_minion_attack_cooldown,
                          .boss_attack_cooldown = config.room_boss_attack_cooldown,
                      },
